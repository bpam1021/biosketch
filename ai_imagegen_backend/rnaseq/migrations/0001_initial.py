# Generated by Django 4.2.7 on 2025-08-20 02:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0012_alter_presentation_presentation_type_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expression_matrix', models.FileField(blank=True, null=True, upload_to='rnaseq/matrices/')),
                ('expression_matrix_output', models.FileField(blank=True, null=True, upload_to='rnaseq/output_matrices/')),
