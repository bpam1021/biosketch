...
class AnalysisJob(models.Model):
    ...
    # Results and outputs
    results_file = models.FileField(upload_to='rnaseq/results/', null=True, blank=True, max_length=500)
    visualization_image = models.ImageField(upload_to='rnaseq/visualizations/', null=True, blank=True, max_length=500)
    qc_report = models.FileField(upload_to='rnaseq/qc/', null=True, blank=True, max_length=500)
